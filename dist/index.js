...
var useStyles$1 = styles.makeStyles(function () { return ({
    root: __assign({ borderRadius: "20px", boxShadow: "none", lineHeight: 1.65, padding: "3px 13px 3px 19px" }, polished.transitions(["background", "borderColor"], "250ms cubic-bezier(0.4, 0, 0.2, 1) 0s")),
    outlinedSizeSmall: {
...
var Button = function (_a) {
    ...
    return (jsxRuntime.jsx(core.Button, __assign({ classes: classes }, props, { children: children }), void 0));
};
...
var SvgComponent$2 = function (props) { return (jsxRuntime.jsx("svg", __assign({ viewBox: '0 0 10 10', xmlns: 'http://www.w3.org/2000/svg' }, props, { children: jsxRuntime.jsx("path", { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M1 0a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1H1Zm3.96 6.906a.311.311 0 0 1-.433 0L2.582 4.961a.311.311 0 0 1 0-.434l.422-.422a.297.297 0 0 1 .422 0L4.75 5.418l2.813-2.813a.297.297 0 0 1 .421 0l.422.422a.311.311 0 0 1 0 .434L4.961 6.906Z' }, void 0) }), void 0)); };

var SvgComponent$1 = function (props) { return (jsxRuntime.jsxs("svg", __assign({ viewBox: '0 0 10 10', xmlns: 'http://www.w3.org/2000/svg' }, props, { children: [jsxRuntime.jsx("rect", { rx: 1 }, void 0), jsxRuntime.jsx("path", { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M9 1H1v8h8V1ZM3 4a1 1 0 0 0 0 2h4a1 1 0 0 0 0-2H3Z' }, void 0)] }), void 0)); };

var SvgComponent = function (props) { return (jsxRuntime.jsx("svg", __assign({ viewBox: '0 0 10 10', fill: 'none', xmlns: 'http://www.w3.org/2000/svg' }, props, { children: jsxRuntime.jsx("rect", { x: 0.5, y: 0.5, width: 9, height: 9, rx: 0.5 }, void 0) }), void 0)); };
...
var Checkbox = function (props) {
    ...
    return (jsxRuntime.jsx(core.Checkbox, __assign({ disableRipple: true, className: classes.root, color: 'default', checkedIcon: jsxRuntime.jsx(SvgComponent$2, { className: clsx(classes.icon, classes.checkedIcon) }, void 0), icon: jsxRuntime.jsx(SvgComponent, { className: clsx(classes.icon, classes.uncheckedIcon) }, void 0), indeterminateIcon: jsxRuntime.jsx(SvgComponent$1, { className: clsx(classes.icon, classes.indeterminateIcon) }, void 0) }, props), void 0));
};
...
var AsyncAutocompletePaginated = function (_a) {
    ...
    var _o = react.useState(0), offset = _o[0], setOffset = _o[1];
    var _isMounted = react.useRef(true);
    var _p = react.useState(0), nbItems = _p[0], setNbItems = _p[1];
    var _q = react.useState(true), keepGoing = _q[0], setKeepGoing = _q[1];
    ...
    var fetchData = react.useCallback(function (input, offset) {
    ...
    var renderOption = function (option, state) {
        ...
        return (jsxRuntime.jsx(core.Grid, __assign({ container: true, alignItems: 'center' }, { children: jsxRuntime.jsx(core.Grid, __assign({ item: true, xs: true }, { children: option && option[labelAccessor] ? option[labelAccessor] : option }), void 0) }), void 0));
    };
    react.useEffect(function () {
        if (!valueFilter ||
            debouncedSearchTerm === "" ||
    ...
    return (jsxRuntime.jsx(core.Grid, __assign({ container: true, spacing: 1 }, { children: jsxRuntime.jsx(core.Grid, __assign({ item: true, xs: 9 }, { children: jsxRuntime.jsx(Autocomplete__default["default"], __assign({ filterOptions: function (x) { return x; }, getOptionSelected: function (option) {
                ...
                }, renderInput: function (params) { return (jsxRuntime.jsx(core.TextField, __assign({}, params, { label: label, fullWidth: true, error: error, helperText: helperText, onChange: handleChange, inputProps: __assign(__assign({}, params.inputProps), { value: inputValue }), InputProps: __assign(__assign({}, params.InputProps), { endAdornment: (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [loading && jsxRuntime.jsx(core.CircularProgress, { color: 'inherit', size: 20 }, void 0), params.InputProps.endAdornment] }, void 0)) }) }), void 0)); }, renderOption: renderOption }), void 0) }), void 0) }), void 0));
};

exports.AsyncAutocompletePaginated = AsyncAutocompletePaginated;
